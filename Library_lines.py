{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyMbE9DQTiaFE/2JncDjTGV6",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/elvisshema19-sudo/library-lines/blob/main/Library_lines.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
    ...
    },
    {
      "cell_type": "code",
      "source": [
        "from __main__ import Book, Member, Transaction, Library\n",
        "\n",
      ...
      "metadata": {
        ...
        "id": "sDQZAXxNvLo6",
        "outputId": "e8981347-920e-42a6-bd59-77a2f9c55fff"
      },
      "execution_count": 20,
      "outputs": [
        {
